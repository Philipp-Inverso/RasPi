...
##            if event.type == QUIT:
##                terminate()
##            elif event.type == KEYDOWN or key != keypad.NULL:
...
##                    terminate()
        ...
        if key == '*':
            terminate()
        elif key == '2' and direction != DOWN:
            direction = UP
        elif key == '8' and direction != UP:
            direction = DOWN
        elif key == '4' and direction != RIGHT:
            direction = LEFT
        elif key == '6' and direction != LEFT:
            direction = RIGHT
...
def getRandomLocation():
    return {'x': random.randint(5, CELLWIDTH - 6), 'y': random.randint(5, CELLHEIGHT - 6)}
...
def drawWorm(wormCoords):
    for coord in wormCoords:
        ...
        pygame.draw.rect(DISPLAYSURF, DARKRED, wormInnerSegmentRect)
